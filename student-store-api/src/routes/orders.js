...
router.post("/", async (req, res, next) => {
  try {
    const { customer_name, dorm_number, student_id, email, total_price } = req.body


    if (!customer_name || !dorm_number || !total_price) { // "|| !student_id || !email" -took this out to  see if  it would work
